...
app = FastAPI(title='Backstract Generated APIs - coll-e7ed566cd59d44c289ac5c3a0cdceda9', debug=False,
              docs_url='/charming-galois-5866c3cafe3611ef92110242ac12000573/docs',
              openapi_url='/charming-galois-5866c3cafe3611ef92110242ac12000573/openapi.json')
...
app.include_router(
    router,
    prefix='/charming-galois-5866c3cafe3611ef92110242ac12000573/api',
    tags=['APIs v1']
)
